...
export default function TimedCardOpening() {
	...
	return (
		<ul ref={scope} className=' bg-[#1a1a1a] relative w-full h-screen overflow-hidden'>
			<li className='absolute translate-x-96 translate-y-60 h-96 w-60 rounded-lg  bg-green-700 z-50'></li>
			<li className='absolute rounded-lg translate-y-60 h-96 w-60 bg-red-700 z-50'></li>
			<li className='absolute w-screen h-screen bg-yellow-700'></li>
		</ul>
	);
}
